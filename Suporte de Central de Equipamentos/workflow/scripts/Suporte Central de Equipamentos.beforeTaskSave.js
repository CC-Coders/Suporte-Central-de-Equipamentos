function beforeTaskSave(colleagueId, nextSequenceId, userList) {
	...
	if (nextSequenceId != atividade) {
		if (formMode == "ADD" && getValue("WKNumState") == 4) {
			...
			} else if (hAPI.getCardValue("categoria") == "Transferência Máquina Locada MA") {
				comentario =
					"<h4>Transferência Máquina Locada MA</h4>" +
					"<b>Prefixo: </b> <span>" + hAPI.getCardValue("prefixoTrans") + "</span><br>" +
					"<b>Fornecedor: </b> <span>" + hAPI.getCardValue("selectFornecedor") + "</span><br>" +
					"<b>Data Transferência: </b> <span>" + hAPI.getCardValue("dataTrans") + "</span><br>" +
					"<b>Valor Locação: </b> <span>" + hAPI.getCardValue("valorLocacao") + "</span><br>" +
					"<b>Obra Origem: </b> <span>" + hAPI.getCardValue("obraOrigem") + "</span><br>" +
					"<b>Obra Destino: </b> <span>" + hAPI.getCardValue("obraDestino") + "</span><br>";
				if (hAPI.getCardValue("observacaoAgendamentoCurso") != "") {
					comentario +=
						"<br>" +
						"<h4>Observação: </h4>" +
			...
			else if (hAPI.getCardValue("categoria") == "Alteração Motivo da Falha") {
				comentario =
					"<h4>Alteração Motivo da Falha</h4>" +
					"<b>Prefixo: </b> <span>" + hAPI.getCardValue("prefixoAlt") + "</span><br>" +
					"<b>OS Sisma: </b> <span>" + hAPI.getCardValue("osSisma") + "</span><br>" +
					"<b>Justificativa: </b> <span>" + hAPI.getCardValue("justificativaAlteracao") + "</span><br>"
				if (hAPI.getCardValue("observacaoAgendamentoCurso") != "") {
					comentario +=
						"<br>" +
						"<h4>Observação: </h4>" +
			...
			else if (hAPI.getCardValue("categoria") == "Relatório de Solicitações") {
				comentario =
					"<h4>Relatório de Solicitações</h4>" +
					"<b>Relatório: </b> <span>" + hAPI.getCardValue("SelectRelatorio") + "</span><br>"
				if (hAPI.getCardValue("observacaoAgendamentoCurso") != "") {
					comentario +=
						"<br>" +
						"<h4>Observação: </h4>" +
...
function EnviaNotificacaoEncerramento(numSolic) {
	...
	try {
		...
		if (hAPI.getCardValue("categoria") == "Agendamento de Curso / Orientação") {
			remetente = BuscaRemetentes()
			html += CorpoEmailAgendamentoCurso();
		}

		else if (hAPI.getCardValue("categoria") == "Transferência Máquina Locada MA") {
			remetente = "implantacaosisma@castilho.com.br; control@castilho.com.br; "
			//TESTE     remetente = "paola.rosa.castilho@outlook.com; paola.rosa@castilho.com.br; "
			html += "<div>\
				                <b>Prefixo: </b><span>" + hAPI.getCardValue("prefixoTrans") + "</span><br>\
				                <b>Fornecedor: </b><span>" + hAPI.getCardValue("selectFornecedor") + "</span><br>\
				                <b>Valor Locação: </b><span>" + hAPI.getCardValue("valorLocacao") + "</span><br>\
		...
		log.info("variavel remetente:" + remetente)
		log.info("html do suporte:" + html)
		var data = {
...
function BuscaRemetentes() {
	...
	var listRemetentes = "implantacaosisma@castilho.com.br; ";//Prod
